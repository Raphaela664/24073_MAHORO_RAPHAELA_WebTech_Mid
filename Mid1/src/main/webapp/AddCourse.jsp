...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            ...
            String courseDefId = request.getParameter("definition");
            ...
            <div class="bg-white tm-block">
                ...
                <div class="row mt-4 tm-edit-product-row">
                    <div class="col-xl-7 col-lg-7 col-md-12">
                        <form action="AddCourse.jsp" class="tm-edit-product-form" method="POST">

                            <div class="input-group mb-3">
                                <label for="definition" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Definition
                                </label>

                                <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" id="definition" name="definition">
                                    <option selected>Select one</option>
                                    <%

                                        List<CourseDefinition> DefinitionList = courseDefinitionService.findAllCourseDefinitions();
                                        for(CourseDefinition def : DefinitionList ) {
                                    %>
                                    <option value="<%= def.getID().toString() %>"><%= def.getName() %></option>
                                    <%
                                        }
                                    %>
                                </select>
                            ...
                            <div class="input-group mb-3">
                                <label for="qualification" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Teacher
                                </label>

                                <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" id="qualification" name="teacher">
                                    <option selected>Select one</option>
                                    <%

                                        List<Teacher> teacherList = teacherService.fetchAllTeachers();
                                        for(Teacher tr : teacherList ) {
                                    %>
                                    <option value="<%= tr.getID().toString() %>"><%= tr.getNames() %></option>
                                    <%
                                        }
                                    %>
                                </select>
