...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            ...
            request.getRequestDispatcher("studBySemandDep.jsp").forward(request,response);
    ...
    <div class="container">
        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="table-responsive">
                <form method="POST" action="studBySemandDep.jsp">
                    <h2 class="text-center">Students Per Department and Semester</h2>
                ...
                <table class="bg-white table table-hover table-striped tm-table-striped-even mt-3">
                    ...
                    <%
                        ...
                        if (selectedSemester != null && selecteddepartment != null) {
                            ...
                            StudRegList = StdRegServ.getStudentsByDepartmentAndSemester(department, semester);
