<%@ page import="com.example.mid1.model.StudentRegistration" %>
<%@ page import="com.example.mid1.service.StudentRegistrationService" %>
<%@ page import="com.example.mid1.service.StudentRegistrationServiceImpl" %>
...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%
    StudentRegistration cr = new StudentRegistration();
    StudentRegistrationService StdRegServ = new StudentRegistrationServiceImpl();
    SemesterService semServ = new SemesterServiceImpl();
    List<StudentRegistration> StudRegList = new ArrayList<>();
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {

            request.setAttribute("semester", request.getParameter("semester"));
            request.getRequestDispatcher("stdBySem.jsp").forward(request,response);
        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="table-responsive">
                <form method="POST" action="stdBySem.jsp">
                    <h2 class="text-center">Students Per Semester</h2>
                ...
                <table class="bg-white table table-hover table-striped tm-table-striped-even mt-3">
                    ...
                    <%
                        ...
                        if (selectedSemester != null ) {
                            ...
                            StudRegList = StdRegServ.getStudentsBySemester(semester);
                            for (StudentRegistration studRegg : StudRegList) {
                    %>

                    <tr>
                        <td><%= studRegg.getStudent().getRegNo() %></td>
                        <td><%= studRegg.getStudent().getFirstName()%></td>

                        <td><%= studRegg.getStudent().getDateOfBirth() %></td>
