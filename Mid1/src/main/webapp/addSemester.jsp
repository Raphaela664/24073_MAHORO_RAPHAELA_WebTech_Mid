...
<%@ page import="com.example.mid1.service.SemesterServiceImpl" %>
<%@ page import="com.example.mid1.service.SemesterService" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.UUID" %>
<%@ page import="java.time.LocalDate" %>
<%
    Semester semester = new Semester();
    SemesterService semesterServ = new SemesterServiceImpl();

    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            semester.setID(UUID.randomUUID());

            semester.setSemester_id(request.getParameter("semester_id"));
            ...
            semesterServ.addSemester(semester);
    ...
    <div class="row tm-mt-big">
        <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
            <div class="bg-white tm-block">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Add Semester</h2>
                    </div>
                </div>
                <div class="row mt-4 tm-edit-product-row">
                    <div class="col-xl-7 col-lg-7 col-md-12">
                        <form action="addSemester.jsp" class="tm-edit-product-form" method="POST">
                            <div class="input-group mb-3">
                                <label for="semester_id" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Semester id

                                </label>
                                <input id="semester_id" name="semester_id" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>
                            <div class="input-group mb-3">
                                <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 mb-2">Semester Name</label>
                                <input id="name" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>

                            <div class="input-group mb-3">
                                <label for="start_date" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label"> Start Date
                                </label>
                                <input id="start_date" name="startDate" type="date" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"
                                       data-large-mode="true">
                            </div>
                            <div class="input-group mb-3">
                                <label for="end_date" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label"> Start Date
                                </label>
                                <input id="end_date" name="endDate" type="date" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7"
                                       data-large-mode="true">
                            </div>
