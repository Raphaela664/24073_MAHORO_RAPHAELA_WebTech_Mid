...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            ...
            teacher.setTeacher_code(request.getParameter("code"));
            String qualification = request.getParameter("qualification");
            EQualification teachEnum = EQualification.valueOf(qualification);
            ...
            <div class="bg-white tm-block">
                ...
                <div class="row mt-4 tm-edit-product-row">
                    <div class="col-xl-7 col-lg-7 col-md-12">
                        <form action="addTeacher.jsp" class="tm-edit-product-form" method="POST">
                            <div class="input-group mb-3">
                                <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Teacher code

                                </label>
                                <input id="name" name="code" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>
                            <div class="input-group mb-3">
                                <label for="firstName" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 mb-2"> Names</label>
                                <input id="firstName" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>

                            <div class="input-group mb-3">
                                <label for="qualification" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Qualification
                                </label>
                                <select class="custom-select col-xl-9 col-lg-8 col-md-8 col-sm-7" id="qualification" name="qualification">
