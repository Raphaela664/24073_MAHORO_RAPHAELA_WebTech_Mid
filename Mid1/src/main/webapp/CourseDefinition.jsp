...
<%@ page import="com.example.mid1.model.CourseDefinition" %>
<%@ page import="com.example.mid1.service.CourseDefinitionServiceImpl" %>
<%@ page import="com.example.mid1.service.CourseDefinitionService" %>
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            coursedef.setID(UUID.randomUUID());

            coursedef.setCode(request.getParameter("code"));
            coursedef.setName(request.getParameter("name"));
            coursedef.setDescription(request.getParameter("description"));


            courseDefinitionService.addCourseDefinition(coursedef);
    ...
    <div class="row tm-mt-big">
        <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
            <div class="bg-white tm-block">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-block-title d-inline-block">Course Definition</h2>
                    </div>
                </div>
                <div class="row mt-4 tm-edit-product-row">
                    <div class="col-xl-7 col-lg-7 col-md-12">
                        <form action="CourseDefinition.jsp" class="tm-edit-product-form" method="POST">
                            <div class="input-group mb-3">
                                <label for="code" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Course code

                                </label>
                                <input id="code" name="code" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>
                            <div class="input-group mb-3">
                                <label for="name" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Course Name

                                </label>
                                <input id="name" name="name" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>
                            <div class="input-group mb-3">
                                <label for="firstName" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 mb-2">Course Description</label>
                                <input id="firstName" name="description" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                            </div>
